...
### Example Workflow
This package is most usefull for investors applying advanced filtering or algorithms to determine which loans to buy.  The algorithms aren't in scope for this package but it does enable the automation. The code below is an example of how you go about using the package.  This isn't investment advice and you should decide for yourself how to choose investments. I would, however,  recommend establishing a limit on how many loans you put in the order. The max is determined by the amount of available funds in your account but you could do less if you wanted. 
