...
g<- ggplot(dat)
g<- g + aes(y= as.Date(Sys.time())-orderDate, x= CFRatio, group= portfolioName, color= simpleStatus)
g<- g + geom_point()
# g<- g + scale_x_date(limits= c(ThreeYear-150, as.Date(Sys.time())+50))
g<- g + scale_y_continuous()
g<- g + facet_wrap(~portfolioName, ncol=2)
g<- g + theme_classic()
g<- g + labs(y= "Age in Days",
             x= "Payback Ratio")
g<- g + geom_vline(xintercept = 100, linetype="dashed")
